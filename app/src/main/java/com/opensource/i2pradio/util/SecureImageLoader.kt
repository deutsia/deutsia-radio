 ...
 *
 * When cover art is disabled in settings, remote URLs are not loaded.
 *
...
fun ImageView.loadSecure(
    ...
    if (PreferencesHelper.isCoverArtDisabled(context)) {
 ...
 *
 * Behavior:
 * - If cover art is disabled: Skips loading remote images
